...
export default function ReferatPage() {
  return (
    <WorkTypeLanding
      slug="referat"
      type="Реферат"
      title="Реферат сдан. Следующий — тоже."
      subtitle="Двенадцатый реферат за семестр, и снова оформлять вручную? Загрузи файл — AI оформит за 2 минуты. Экономь 8 часов за семестр."
      identityLine="Двенадцатый реферат за семестр. Серьёзно, снова вручную — и до дедлайна 3 часа?"
