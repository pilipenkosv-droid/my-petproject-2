...
export default function EssePage() {
  return (
    <WorkTypeLanding
      slug="esse"
      type="Эссе"
      title="Эссе написано. Осталось сдать."
      subtitle="Эссе готово, а препод требует «привести в порядок оформление»? Загрузи файл — AI оформит за 40 секунд по требованиям."
      identityLine="Эссе написано, сдавать завтра — а оформление ещё не начинал?"
