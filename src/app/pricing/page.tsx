...
const plans = [
  {
    ...
    features: [
      ...
      { text: "AI-инструменты с превью 50% результата" },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "50 AI-операций/мес без обрезки результата", highlight: true },
      { text: "Рерайт, конспект, план, чат по методичке — полностью" },
      { text: "Грамматика и поиск источников — без лимита" },
      { text: "Без ограничения по страницам" },
