...
export const metadata: Metadata = {
  ...
  description:
    "Автоматическое оформление отчёта по практике по ГОСТу и методичке. Загрузите отчёт — получите документ с правильным титульным листом, содержанием и списком литературы.",
  keywords: [
    "оформление отчета по практике",
    "оформление отчета по практике по госту",
    "отчет по практике пример оформления",
  ...
  openGraph: {
    title: "Оформление отчёта по практике по ГОСТу — Diplox",
    description:
