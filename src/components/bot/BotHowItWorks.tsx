...
const steps = [
  {
    step: "01",
    icon: CreditCard,
    title: "Купи Pro-подписку",
    description: "Оформи подписку за 399 ₽/мес — ссылка на бота придёт автоматически после оплаты.",
    delay: 0.3,
  },
  {
    step: "02",
  ...
  },
  {
    ...
    description: "Генерация плана, проверка грамматики, рерайт, аннотация, дневной конспект — всё в Telegram.",
    delay: 0.6,
  },
];
