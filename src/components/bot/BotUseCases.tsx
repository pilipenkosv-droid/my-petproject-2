...
const useCases = [
  {
    ...
    outcome: "Сдал экзамен, не перечитывая 200 страниц конспектов.",
    delay: 0.2,
  },
  {
    icon: BookOpen,
    ...
    outcome: "Вся теоретическая база — в одном чате, ничего не потерялось.",
    delay: 0.3,
  },
  {
    icon: Mic,
    ...
    outcome: "Ни одна мысль не теряется — даже та, что была в метро.",
    delay: 0.4,
  },
];
