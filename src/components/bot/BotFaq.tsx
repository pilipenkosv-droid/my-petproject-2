...
const faqItems = [
  ...
  },
  {
    ...
    a: "Только из твоих. Если ты не сохранял про квантовую физику — бот честно скажет, что в твоём архиве этого нет. Без додумываний — только твои материалы.",
  },
  {
  ...
  },
  {
    ...
    a: "10 обработок документов в месяц (форматирование по ГОСТу), проверка грамматики, перефразирование, генерация плана работы, подбор литературы. Всё это ещё и доступно прямо в Telegram.",
  },
  {
