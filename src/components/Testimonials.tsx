...
const testimonials = [
  ...
  },
  {
    name: "Полина Ж.",
    university: "РУДН",
    workType: "Курсовая работа · 36 страниц",
    rating: 5,
    text: "Получила 5 по курсовой — спустя 6 попыток написать самой и другими способами. Преподаватель сказал: «Наконец-то работа, к которой не придраться». Оформление Diplox сделал за 3 минуты — я бы возилась весь вечер.",
  },
  {
    name: "Тимур А.",
    university: "КубГУ",
    workType: "Дипломная работа · 79 страниц",
    rating: 5,
    text: "Лобная кора саботировала всё — сидел перед экраном час и не мог начать. За 20 минут набросал план в Diplox, сел и поехал. А оформление диплома потом прошло с первого раза — даже нормоконтролёр не придрался.",
  },
  {
    name: "Алексей Р.",
    university: "ИТМО",
