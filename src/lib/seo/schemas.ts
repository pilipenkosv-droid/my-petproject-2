...
export function getSoftwareApplicationSchema() {
  return {
    ...
    description:
      'Сервис автоматического форматирования научных работ по ГОСТу и методическим указаниям вуза. Загрузите работу и методичку — получите идеально оформленный документ.',
    url: BASE_URL,
    featureList: [
