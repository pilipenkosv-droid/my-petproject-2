...
- Скачивание обоих документов: исправленный + с пометками ошибок
...
- **Hook-Offer**: для trial сохраняется полная версия документа, доступная после оплаты
- Авторизация: email/password, OAuth (Google), восстановление пароля
- Адаптивный интерфейс с мобильной вёрсткой
- Отображение времени хранения документов (24 часа)
...
| БД и хранилище | Supabase (PostgreSQL + Auth + Storage + RLS) |
| Оплата | Lava.top |
| Деплой | Vercel |
...
|-------|------|-----------|---------------|
| Пробный | 0 ₽ | 1 бесплатная | 50% документа |
